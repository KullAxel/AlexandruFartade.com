...
}, 238506:() => void 0 !== navigator.mediaDevices && void 0 !== navigator.mediaDevices.getUserMedia, 238610:() => {
  try {
...
}, 241658:a => window.h.sa(a).I.sampleRate, 241731:a => {
  a = window.h.sa(a);
